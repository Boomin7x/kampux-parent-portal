...
export const aboutSectionContent = {
    ...
    // Subtitle
    subtitle: "Empowering students through innovative education and dedicated mentorship.",

    // Main Story Content
    story: {
        title: "Our Story",
        content: "Excellence Academy is dedicated to providing a comprehensive, challenging, and supportive educational experience. We foster critical thinking, creativity, and character development while maintaining the highest academic standards.",
    },
