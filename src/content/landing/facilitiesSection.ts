...
export const facilitiesSectionContent = {
    ...
    // Subtitle
    subtitle: "Modern infrastructure designed to inspire learning and support student success.",
    ...
    featuredFacilities: [
        {
            ...
            description: "State-of-the-art laboratories equipped with cutting-edge technology for hands-on scientific exploration and research.",
        ...
        },
        {
            ...
            description: "Comprehensive learning hub with extensive digital resources, collaborative spaces, and quiet study areas.",
            icon: "LocalLibrary",
            color: "#8b5cf6",
        ...
        },
        {
            ...
            description: "Cutting-edge computer labs and innovation spaces supporting coding, design, and emerging technologies.",
            icon: "Computer",
            color: "#6366f1",
        ...
        },
        {
            ...
            description: "Multi-purpose sports facilities designed to promote physical fitness, teamwork, and competitive excellence.",
            icon: "FitnessCenter",
            color: "#ef4444",
        ...
        },
        {
            id: "dining-hall",
            title: "Dining Hall",
            description: "Nutritious dining program featuring fresh, locally-sourced meals in a welcoming environment.",
            icon: "Restaurant",
            color: "#f59e0b",
            capacity: "400+ seats",
        ...
        },
        {
            ...
            description: "Comprehensive safety and security systems ensuring a secure, nurturing learning environment.",
            icon: "Security",
            color: "#dc2626",
    ...
    campusTour: {
        ...
        description: "Schedule a personalized tour to see our world-class facilities and experience the Excellence Academy difference firsthand.",
