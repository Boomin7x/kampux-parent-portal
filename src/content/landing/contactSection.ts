...
export const contactSectionContent = {
    ...
    // Subtitle
    subtitle: "Ready to begin your educational journey? We're here to guide you every step of the way.",
        ...
        items: [
            {
                ...
                description: "Monitor your child's academic progress, view assignments, track attendance, and stay connected with educators.",
                icon: "School",
                color: "#6366f1",
            ...
            },
            {
                ...
                description: "Experience our world-class facilities and meet our dedicated team of educators.",
                icon: "TourOutlined",
                color: "#10b981",
                buttonText: "Book Now",
