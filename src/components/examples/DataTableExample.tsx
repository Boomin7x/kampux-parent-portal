...
import { ResponsiveDataTable, columnBuilders, type TableColumn } from '../ui/DataTable';
    ...
    return (
        <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary" paragraph>
                ...
                including responsive design, virtualization, filtering, and more.
            </Typography>
            ...
            <Paper sx={{ p: 3, mb: 3 }}>
                ...
                <Stack direction="row" spacing={3} flexWrap="wrap">
                    <Stack direction="row" spacing={1} alignItems="center">
                        ...
                        <Button
                            size="small"
                            variant={dataSize === 100 ? 'contained' : 'outlined'}
                        ...
                        <Button
                            size="small"
                            variant={dataSize === 1000 ? 'contained' : 'outlined'}
                        ...
                        <Button
                            size="small"
                            variant={dataSize === 10000 ? 'contained' : 'outlined'}
                    ...
                    <FormControlLabel
                        control={
                            <Switch
                                ...
                                onChange={(e) => setServerSideMode(e.target.checked)}
                ...
                <Stack spacing={2}>
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Automatically switches to card view on mobile devices with customizable field display.
                        </Typography>
                    </Box>
                    <Box>
                        <Typography variant="subtitle2" fontWeight="bold" color="primary">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Handle large datasets efficiently with virtual scrolling (enabled for 500+ rows).
                        </Typography>
                    </Box>
                    <Box>
                        <Typography variant="subtitle2" fontWeight="bold" color="primary">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Multiple filter types including text search, select dropdowns, date ranges, and number ranges.
                        </Typography>
                    </Box>
                    <Box>
                        <Typography variant="subtitle2" fontWeight="bold" color="primary">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Export filtered data to CSV, Excel, JSON, or PDF formats with customizable options.
                        </Typography>
                    </Box>
                    <Box>
                        <Typography variant="subtitle2" fontWeight="bold" color="primary">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Show/hide columns, resize, and reorder with intuitive controls.
                        </Typography>
                    </Box>
                    <Box>
                        <Typography variant="subtitle2" fontWeight="bold" color="primary">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Single or multi-row selection with bulk actions support.
                        </Typography>
                    </Box>
                </Stack>
            </Paper>
