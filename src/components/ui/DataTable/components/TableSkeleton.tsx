...
export function TableSkeleton({
    ...
    const generateColumnWidths = (columnCount: number) => {
        ...
        for (let i = 0; i < columnCount; i++) {
            if (i === 0)
                widths.push('20%'); // First column (usually ID or selection)
            else if (i === columnCount - 1)
                widths.push('15%'); // Last column (usually actions)
        ...
        <Box>
            ...
            <TableContainer
                ...
                sx={{
                    ...
                    borderTopLeftRadius: showToolbar
                        ? 0
                        : theme.shape.borderRadius,
                    borderTopRightRadius: showToolbar
                        ? 0
                        : theme.shape.borderRadius,
                }}
            >
